...
/**
 * Email attachment configuration for QR code
 * This ensures consistent attachment format across all emails
 */
export function getQRCodeAttachment(bookingId: number, qrBuffer: Buffer) {
    return {
        filename: `ticket-${bookingId}.png`,
        content: qrBuffer,
        contentId: 'ticket-qr', // IMPORTANT: Use camelCase for Resend API
    };
}
