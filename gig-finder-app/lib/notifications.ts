...
export async function sendNewVenueNotification(venueName: string, city?: string, capacity?: number, createdBy?: string) {
    try {
        ...
        if (!process.env.RESEND_API_KEY) {
            ...
            return { success: true, message: 'DEV MODE: Notification logged to console' };
        }
        ...
        console.log(`✅ Admin notification sent for new venue: ${venueName}`);
