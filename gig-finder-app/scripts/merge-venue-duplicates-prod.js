...
async function mergeVenueDuplicates() {
    ...
    try {
        console.log('🔧 Starting PRODUCTION Venue Duplicate Merge Process...\n');
        ...
        console.log(`   Total venues remaining: ${finalVenueCount.rows[0].count} (removed ${totalVenuesDeleted})`);
        ...
        console.log('═'.repeat(80));
        console.log('🎉 PRODUCTION MERGE COMPLETE!\n');
        console.log(`   📊 Summary:`);
