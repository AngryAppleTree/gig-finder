        ...
        try {
            ...
            if (res.ok) {
                if (isNewVenue) {
                    ...
                    router.push(`/gigfinder/add-event-v2?newVenue=${encodeURIComponent(venueInput)}`);
                } else {
                    // Normal success
...
export default function AddEventPageV2() {
    return (
        <div style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff' }}>
            ...
            <main className="container" style={{ maxWidth: '800px', margin: '0 auto', padding: '2rem 1rem' }}>
                <div style={{ background: 'var(--color-surface)', padding: '2rem', border: '3px solid var(--color-border)', boxShadow: '8px 8px 0 var(--color-primary)' }}>
                    <h2 style={{ fontFamily: 'var(--font-primary)', fontSize: '2rem', marginBottom: '1.5rem', textAlign: 'center', textTransform: 'uppercase' }}>Add Your Event (V2)</h2>
